...
public class SdiEntrega2Test20219142021901ApplicationTests {
	...
	static String Geckdriver024 = "G:\\UNIVERSIDAD\\3º\\2ºSemestre\\Sistemas Distribuidos e Internet\\LABORATORIO\\PL-SDI-Sesión5-material\\PL-SDI-Sesión5-material\\geckodriver022win64.exe";
	...
	public void initdb() {
		...
		filter = Filters.eq("", "");
		database.getCollection("conversaciones").deleteMany(filter);
	...
	// [Prueba26]Sobre una búsqueda determinada (a elección de desarrollador),
	// intentar comprar una oferta que esté por encima de saldo disponible del
	// comprador. Y comprobar que se muestra el mensaje de saldo no suficiente.
	@Test
	public void PR26() {
	...
	// [Prueba32] Inicio de sesión con datos inválidos (campos vacios).
	@Test
	public void PR32() {
		URL = "http://localhost:8081/cliente.html";
		initdb();
	...
	// [Prueba34] Mostrar el listado de ofertas disponibles y comprobar que se
	// muestran todas las que existen, menos las del usuario identificado.
	@Test
	public void PR34() {
		URL = "http://localhost:8081/cliente.html";
